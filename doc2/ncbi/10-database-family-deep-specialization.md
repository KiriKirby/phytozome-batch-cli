...
- support â€œjump to related gene / ClinVar / MedGen / GTR / OMIMâ€?actions as first-class review operations
...
- expose only after the UI can clearly signal â€œspecialist metadata modeâ€?
...
The product should never again treat â€œNCBIâ€?as one workflow shape. The correct level of specialization is:
