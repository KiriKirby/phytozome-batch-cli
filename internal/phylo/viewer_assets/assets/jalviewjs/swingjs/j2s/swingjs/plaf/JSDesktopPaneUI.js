...
{
if (window && window.__PHGOJalviewState && this.domNode) {
...
{
if (window && window.__PHGOJalviewState && this.desktop && this.desktop.setOpaque$Z) {
this.desktop.setOpaque$Z(false);
}
}
});
