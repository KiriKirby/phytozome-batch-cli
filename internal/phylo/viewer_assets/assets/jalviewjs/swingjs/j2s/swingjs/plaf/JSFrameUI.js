...
return this.domNode;
}var phgoMainAlignmentFrame=this.frame && this.frame.__phgoMainAlignmentFrame;
var phgoRootDesktopFrame=false;
...
var fname=phgoMainAlignmentFrame ? "jalview-alignment" : this.frame.getName$();
var node=$I$(3).getElement(fname + "-div");
if (node != null ) {
phgoRootDesktopFrame=!phgoMainAlignmentFrame && node.id == "jalview-desktop-div";
if (phgoRootDesktopFrame) this.frame.__phgoRootDesktopFrame=true;
...
if (phgoMainAlignmentFrame || phgoRootDesktopFrame) {
    ew=Math.max(320, Math.floor((window && (window.innerWidth || document.documentElement.clientWidth)) || ew || w || 1024));
    eh=Math.max(240, Math.floor((window && (window.innerHeight || document.documentElement.clientHeight)) || eh || h || 768));
}
if (ew > 0 && eh > 0 ) {
...
if (phgoMainAlignmentFrame || phgoRootDesktopFrame) {
$I$(3).setStyles(this.frameNode, ["position", "absolute", "left", "0px", "top", "0px", "width", "100%", "height", "100%", "box-shadow", "none", "border", "0", "margin", "0", "overflow", "hidden"]);
this.frame.setBounds$I$I$I$I(0, 0, this.frame.getWidth$(), this.frame.getHeight$());
this.syncPhgoEmbeddedBounds$();
if (phgoRootDesktopFrame) {
this.frameNode.className=((this.frameNode.className || "") + " phgo-root-desktop-frame").replace(/^\s+|\s+$/g, "");
this.frameNode.style.background="transparent";
this.frameNode.style.pointerEvents="none";
this.frameNode.style.overflow="visible";
}
}
...
if (this.frame && this.frame.__phgoRootDesktopFrame) {
$I$(3).setStyles(this.domNode, ["background-color", "transparent", "overflow", "visible", "pointer-events", "none"]);
$I$(3).setStyles(this.frameNode, ["background", "transparent", "box-shadow", "none", "border", "0", "overflow", "visible", "pointer-events", "none"]);
}
...
if (this.frame && this.frame.__phgoMainAlignmentFrame) return;
...
Clazz.newMeth(C$, 'syncPhgoEmbeddedBounds$', function () {
if (!this.frame || !(this.frame.__phgoMainAlignmentFrame || this.frame.__phgoRootDesktopFrame) ) {
return false;
}var targetId=this.frame.__phgoMainAlignmentFrame ? "jalview-alignment-div" : "jalview-desktop-div";
var node=$I$(3).getElement(targetId);
var w=node == null  ? 0 : $I$(3).getWidth(node);
var h=node == null  ? 0 : $I$(3).getHeight(node);
{
var doc = document.documentElement || document.body || {};
  w = Math.max(320, Math.floor(window.innerWidth || doc.clientWidth || w || this.defaultWidth || 1024));
  h = Math.max(240, Math.floor(window.innerHeight || doc.clientHeight || h || this.defaultHeight || 768));
}
if (node != null ) {
$I$(3).setStyles(node, ["width", w + "px", "height", h + "px", "overflow", "hidden"]);
}if (this.domNode != null ) {
$I$(3).setStyles(this.domNode, ["position", "absolute", "left", "0px", "top", "0px", "width", w + "px", "height", h + "px", "margin", "0", "overflow", this.frame.__phgoRootDesktopFrame ? "visible" : "hidden"]);
}if (this.frameNode != null ) {
$I$(3).setStyles(this.frameNode, ["position", "absolute", "left", "0px", "top", "0px", "width", w + "px", "height", h + "px", "margin", "0", "overflow", this.frame.__phgoRootDesktopFrame ? "visible" : "hidden", "box-shadow", "none", "border", "0"]);
}this.width=w;
this.height=h;
this.bounds=Clazz.new_($I$(9).c$$I$I$I$I,[0, 0, w, h]);
try {
this.setInnerComponentBounds$I$I(w, h);
} catch (e) {
}
try {
var root=this.frame.getRootPane$ == null  ? null : this.frame.getRootPane$();
if (root != null ) {
root.setBounds$I$I$I$I(0, 0, w, h);
var layered=root.getLayeredPane$ == null  ? null : root.getLayeredPane$();
if (layered != null ) layered.setBounds$I$I$I$I(0, 0, w, h);
var glass=root.getGlassPane$ == null  ? null : root.getGlassPane$();
if (glass != null ) glass.setBounds$I$I$I$I(0, 0, w, h);
var content=root.getContentPane$ == null  ? null : root.getContentPane$();
if (content != null ) content.setBounds$I$I$I$I(0, 0, w, h);
if (root.doLayout$ != null ) root.doLayout$();
if (root.validate$ != null ) root.validate$();
}
} catch (e) {
}
try {
this.frame._freezeBounds$I$I(w, h);
} catch (e) {
}
return true;
});
...
if (this.syncPhgoEmbeddedBounds$()) {
return;
}
