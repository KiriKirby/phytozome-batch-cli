...
Clazz.newMeth(C$, 'setForOutput$', function () {
this.phgoOutputOnly=true;
this.getContentPane$().remove$java_awt_Component(this.inputButtonPanel);
this.editMenu.remove$javax_swing_JMenuItem(this.pasteMenu);
this.editMenubar.remove$java_awt_Component(this.jMenu1);
});
