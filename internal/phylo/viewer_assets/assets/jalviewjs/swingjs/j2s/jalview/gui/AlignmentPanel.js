...
if (bridge && bridge.phgoState && bridge.phgoState.session) phgoExtra=bridge.checkboxColumnWidth();
}
return Clazz.new_($I$(9).c$$I$I,[maxwidth < 0 ? idWidth + phgoExtra : Math.min(maxwidth, idWidth + phgoExtra), 12]);
});
