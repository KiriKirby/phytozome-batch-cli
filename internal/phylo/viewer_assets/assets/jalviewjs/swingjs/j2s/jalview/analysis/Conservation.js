...
var sm=$I$(10).getInstance$().getBlosum62$();
if (sm == null ) {
this.quality=Clazz.new_($I$(11));
return;
}
this.findQuality$I$I$jalview_analysis_scoremodels_ScoreMatrix(0, this.maxLength - 1, sm);
});
...
var qmin=0.0;
var qmax=0.0;
var hasQuality=this.quality != null  && this.quality.size$() >= alWidth ;
