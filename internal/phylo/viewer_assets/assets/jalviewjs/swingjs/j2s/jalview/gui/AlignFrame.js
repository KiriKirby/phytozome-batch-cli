...
break;
case 40:
if (!$I$(10).isJS$() && (evt.isAltDown$() || !this.b$['jalview.gui.AlignFrame'].viewport.cursorMode) ) {
...
case 32:
if (!$I$(10).isJS$() && this.b$['jalview.gui.AlignFrame'].viewport.cursorMode) {
...
{
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] output-text-start", fileFormatName);
}
...
cap.phgoOutputOnly=true;
if (cap.setForOutput$ != null ) {
cap.setForOutput$();
} else {
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] output-text-no-setForOutput");
}
try {
...
{
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] output-text-added", this.$finals$.fileFormat.getName$());
}
} catch (oom) {
...
var phgoSkipOutputOptions=($I$(10).isJS$() && ((typeof J2S != "undefined" && J2S.thisApplet && J2S.thisApplet.__Info && J2S.thisApplet.__Info.jalview_PHGO_SESSION) || (window && window.__PHGOJalviewState)));
if (!phgoSkipOutputOptions && $I$(36).isNeeded$jalview_api_AlignViewportI$jalview_io_FileFormatI(this.viewport, fileFormat)) {
