...
if ($I$(11).isJS$() && window && window.__PHGOJalviewState && C$.desktop.setOpaque$Z != null ) {
C$.desktop.setOpaque$Z(false);
}
...
var phgoMainAlignmentFrame=false;
if ($I$(11).isJS$() && Clazz.instanceOf(frame, "jalview.gui.AlignFrame") && C$.phgoMainAlignmentFrame == null ) {
phgoMainAlignmentFrame=true;
C$.phgoMainAlignmentFrame=frame;
frame.__phgoMainAlignmentFrame=true;
window.__PHGOMainAlignmentFrame=frame;
frame.setName$S("jalview-alignment");
{
var phgoState=window && window.__PHGOJalviewState;
var phgoInfo=(typeof J2S != "undefined" && J2S.thisApplet && J2S.thisApplet.__Info) || {};
var phgoKind=(phgoInfo.jalview_PHGO_CONVERSION_TARGET || phgoInfo.jalview_PHGO_SEQUENCE_KIND || (phgoState && (phgoState.conversionTarget || phgoState.sequenceKind)));
if (phgoKind != null ) {
phgoKind=("" + phgoKind).toLowerCase();
var phgoKnown=phgoKind == "protein" || phgoKind == "peptide" || phgoKind == "aa" || phgoKind == "nucleotide" || phgoKind == "dna" || phgoKind == "rna";
if (phgoKnown && frame.getViewport$ != null ) {
var phgoNucleotide=phgoKind == "nucleotide" || phgoKind == "dna" || phgoKind == "rna";
var phgoAlignment=frame.getViewport$().getAlignment$();
if (phgoAlignment != null ) {
phgoAlignment.nucleotide=phgoNucleotide;
try {
var phgoDataset=phgoAlignment.getDataset$();
if (phgoDataset != null ) phgoDataset.nucleotide=phgoNucleotide;
} catch (e) {
}
}
frame.__phgoSequenceKind=phgoNucleotide ? "nucleotide" : "protein";
}
}
}
{
var width=Math.max(320, Math.floor((window && (window.innerWidth || document.documentElement.clientWidth)) || w || 1024));
var height=Math.max(240, Math.floor((window && (window.innerHeight || document.documentElement.clientHeight)) || h || 768));
w=width;
h=height;
}
frame.setLocation$I$I(0, 0);
{
if (window && !window.__PHGOJalviewResizeInstalled) {
window.__PHGOJalviewResizeInstalled=true;
window.__PHGOJalviewResizeMainAlignment=function() {
try {
var f=C$.phgoMainAlignmentFrame;
if (f == null ) return;
var node=document.getElementById("jalview-alignment-div");
var desktopNode=document.getElementById("jalview-desktop-div");
var doc=document.documentElement || document.body || {};
var rect=node && node.getBoundingClientRect ? node.getBoundingClientRect() : null;
var width=Math.max(320, Math.floor(window.innerWidth || doc.clientWidth || (rect && rect.width) || (node && node.clientWidth) || 1024));
var height=Math.max(240, Math.floor(window.innerHeight || doc.clientHeight || (rect && rect.height) || (node && node.clientHeight) || 768));
if (node != null ) {
node.style.width=width + "px";
node.style.height=height + "px";
}
if (desktopNode != null ) {
desktopNode.style.width=width + "px";
desktopNode.style.height=height + "px";
}
try {
var root=C$.instance;
if (root != null ) {
root._boundsFrozen=false;
root.setBounds$I$I$I$I(0, 0, width, height);
root._boundsFrozen=true;
if (root.ui != null  && root.ui.syncPhgoEmbeddedBounds$ != null ) root.ui.syncPhgoEmbeddedBounds$();
var rcp=root.getContentPane$ == null  ? null : root.getContentPane$();
if (rcp != null  && rcp.setBounds$I$I$I$I != null ) rcp.setBounds$I$I$I$I(0, 0, width, height);
if (rcp != null  && rcp.doLayout$ != null ) rcp.doLayout$();
if (rcp != null  && rcp.validate$ != null ) rcp.validate$();
}
if (C$.desktop != null ) {
C$.desktop.setBounds$I$I$I$I(0, 0, width, height);
if (C$.desktop.doLayout$ != null ) C$.desktop.doLayout$();
if (C$.desktop.validate$ != null ) C$.desktop.validate$();
}
} catch (e) {
}
f._boundsFrozen=false;
f.setBounds$I$I$I$I(0, 0, width, height);
f._boundsFrozen=true;
try {
if (f.ui != null  && f.ui.syncPhgoEmbeddedBounds$ != null ) f.ui.syncPhgoEmbeddedBounds$();
} catch (e) {
}
try {
var cp=f.getContentPane$ == null  ? null : f.getContentPane$();
if (cp != null  && cp.setBounds$I$I$I$I != null ) cp.setBounds$I$I$I$I(0, 0, width, height);
if (cp != null  && cp.doLayout$ != null ) cp.doLayout$();
if (cp != null  && cp.validate$ != null ) cp.validate$();
} catch (e) {
}
try {
if (f.alignPanel != null ) {
if (f.alignPanel.setBounds$I$I$I$I != null ) f.alignPanel.setBounds$I$I$I$I(0, 0, width, height);
if (f.alignPanel.adjustAnnotationHeight$ != null ) f.alignPanel.adjustAnnotationHeight$();
if (f.alignPanel.validate$ != null ) f.alignPanel.validate$();
if (f.alignPanel.paintAlignment$Z$Z != null ) f.alignPanel.paintAlignment$Z$Z(true, true);
if (f.alignPanel.repaint$ != null ) f.alignPanel.repaint$();
}
} catch (e) {
}
if (f.doLayout$ != null ) f.doLayout$();
if (f.validate$ != null ) f.validate$();
if (f.repaint$ != null ) f.repaint$();
} catch (e) {
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] source-resize-failed", e);
}
};
window.__PHGOJalviewScheduleResizeMainAlignment=function() {
if (window.__PHGOJalviewResizeTimer) window.clearTimeout(window.__PHGOJalviewResizeTimer);
window.__PHGOJalviewResizeTimer=window.setTimeout(function() {
window.__PHGOJalviewResizeTimer=0;
window.__PHGOJalviewResizeMainAlignment();
}, 260);
};
window.addEventListener("resize", window.__PHGOJalviewScheduleResizeMainAlignment);
if (window.visualViewport) window.visualViewport.addEventListener("resize", window.__PHGOJalviewScheduleResizeMainAlignment);
window.setTimeout(window.__PHGOJalviewResizeMainAlignment, 0);
window.setTimeout(window.__PHGOJalviewResizeMainAlignment, 250);
window.setTimeout(window.__PHGOJalviewResizeMainAlignment, 1000);
}
}
}
if ($I$(11).isJS$() && C$.phgoMainAlignmentFrame != null  && !phgoMainAlignmentFrame && Clazz.instanceOf(frame, "jalview.gui.AlignFrame")) {
return;
}
if ($I$(11).isJS$() && C$.phgoMainAlignmentFrame != null  && !phgoMainAlignmentFrame && Clazz.instanceOf(frame, "jalview.gui.SplitFrame")) {
return;
}
if ($I$(11).isJS$() && C$.phgoMainAlignmentFrame != null  && !phgoMainAlignmentFrame && Clazz.instanceOf(frame, "jalview.gui.CutAndPasteTransfer")) {
{
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] output-text-frame", !!frame.phgoOutputOnly, title, w, h);
}
if (frame.phgoOutputOnly) {
} else {
return;
}
}
...
frame.setClosable$Z(!phgoMainAlignmentFrame);
frame.setResizable$Z(phgoMainAlignmentFrame ? false : resizable);
frame.setMaximizable$Z(phgoMainAlignmentFrame ? false : resizable);
frame.setIconifiable$Z(phgoMainAlignmentFrame ? false : resizable);
if (phgoMainAlignmentFrame) {
try {
frame.setGUINucleotide$();
...
if (!phgoMainAlignmentFrame && frame.getX$() < 1 && frame.getY$() < 1 ) {
...
if ($I$(11).isJS$() && Clazz.instanceOf(frame, "jalview.gui.CutAndPasteTransfer") && frame.phgoOutputOnly) {
{
if (window.console && window.console.debug) window.console.debug("[phgo-jalviewjs] output-text-frame-added", frame.getX$(), frame.getY$(), frame.getWidth$(), frame.getHeight$());
}
}
if (!phgoMainAlignmentFrame) $I$(37).windowMenu.add$javax_swing_JMenuItem(menuItem);
frame.toFront$();
try {
