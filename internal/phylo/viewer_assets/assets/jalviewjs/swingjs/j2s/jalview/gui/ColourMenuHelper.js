...
if (phgoKind != null  && coll != null ) {
phgoKind=("" + phgoKind).toLowerCase();
var phgoKnown=phgoKind == "protein" || phgoKind == "peptide" || phgoKind == "aa" || phgoKind == "amino" || phgoKind == "amino_acid" || phgoKind == "nucleotide" || phgoKind == "dna" || phgoKind == "rna" || phgoKind == "na";
if (phgoKnown) {
var phgoNucleotide=phgoKind == "nucleotide" || phgoKind == "dna" || phgoKind == "rna" || phgoKind == "na";
coll.nucleotide=phgoNucleotide;
coll.__phgoSequenceKind=phgoNucleotide ? "nucleotide" : "protein";
if (coll.getDataset$ != null ) {
var phgoDataset=coll.getDataset$();
if (phgoDataset != null ) {
phgoDataset.nucleotide=phgoNucleotide;
phgoDataset.__phgoSequenceKind=coll.__phgoSequenceKind;
}
}
}
}
