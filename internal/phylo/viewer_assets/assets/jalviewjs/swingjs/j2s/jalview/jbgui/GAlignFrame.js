...
var alignFrame=this.b$['jalview.gui.AlignFrame'] || this.b$['jalview.jbgui.GAlignFrame'];
alignFrame.outputText_actionPerformed$S.apply(alignFrame, [e.getActionCommand$()]);
});
})()
...
if (e && e.stack) System.err.println$S(e.stack);
...
if (bridge && bridge.applyMSASelection) bridge.applyMSASelection().catch(function(error){ if (bridge && bridge.debug) bridge.debug("msa-apply-failed", { message: bridge.formatValue ? bridge.formatValue(error) : String(error) }); });
}
});
fileMenu.addSeparator$();
