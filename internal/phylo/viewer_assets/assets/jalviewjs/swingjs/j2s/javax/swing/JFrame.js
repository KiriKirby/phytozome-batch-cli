...
if (this.__phgoMainAlignmentFrame || this.__phgoRootDesktopFrame) {
this._boundsFrozen=false;
}
this.setSize$I$I(w, h);
this._boundsFrozen=(this.__phgoMainAlignmentFrame || this.__phgoRootDesktopFrame) ? wasFrozen : true;
