...
var resource;
try {
resource=C$.cacheLookup$java_util_Locale(desiredLocale);
} catch (e) {
if (Clazz.exceptionOf(e,"java.util.MissingResourceException") || Clazz.exceptionOf(e,"Exception")){
resource=Clazz.new_(Clazz.load('sun.text.resources.FormatData_en'));
} else {
throw e;
}
}
